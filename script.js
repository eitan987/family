...
function enterSite(userType) {
    ...
    renderTasks();
    renderEvents();
    alert(`ברוך הבא כ-${userType}! ${isParent ? "אתה יכול לערוך משימות ואירועים" : "אתה יכול לראות אירועים ולסמן משימות"}`);
}
...
function renderTasks() {
    ...
    tasks.forEach((task, index) => {
        ...
        li.innerHTML = `
            ...
            ${isParent ? `<button onclick="removeTask(${index})">מחק</button>` : 
